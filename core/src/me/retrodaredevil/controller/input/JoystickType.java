...
public final class JoystickType{
	 ...
	 *                      need to be scaled. (Used if the joystick can produce a square output ex: x can be 1 when y is 1) (Normally
	 *                      recommended to be true or recommended to check the range and changing this to true)
